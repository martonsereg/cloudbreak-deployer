...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.4.0-rc.95
    env-import DOCKER_TAG_CLOUDBREAK 1.4.0-rc.95
    env-import DOCKER_TAG_ULUWATU 1.4.0-rc.95
    env-import DOCKER_TAG_SULTANS 1.4.0-rc.95
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.4.0-rc.95
